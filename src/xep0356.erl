...
decode_privilege_perm(__TopXMLNS, __Opts,
    ...
    Namespace = decode_privilege_perm_els(__TopXMLNS,
                                          __Opts,
                                          _els,
                                          []),
    {Access, Type, Push} =
        decode_privilege_perm_attrs(__TopXMLNS,
                                    ...
                                    undefined,
                                    undefined),
    {privilege_perm, Access, Type, Push, Namespace}.
...
encode_privilege_perm({privilege_perm,
    ...
    __NewTopXMLNS =
        xmpp_codec:choose_top_xmlns(<<"urn:xmpp:privilege:2">>,
                                    ...
                                    __TopXMLNS),
    _els =
        lists:reverse('encode_privilege_perm_$namespace'(Namespace,
                                                         __NewTopXMLNS,
                                                         [])),
...
'encode_privilege_perm_$namespace'([], __TopXMLNS,
                                   _acc) ->
    _acc;
'encode_privilege_perm_$namespace'([Namespace | _els],
                                   __TopXMLNS, _acc) ->
    'encode_privilege_perm_$namespace'(_els,
                                       __TopXMLNS,
                                       [encode_privilege_namespace(Namespace,
                                                                   __TopXMLNS)
                                        | _acc]).
